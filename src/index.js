...
message.textContent =
  "This is a basic template for a vanilla javascript project, using webpack as a compiler. The following features are built in:";
...
const webpackFeatures = {
  ...
  "Development Server": ["Watching template file: './src.template.html'"],
  Plugins: [
